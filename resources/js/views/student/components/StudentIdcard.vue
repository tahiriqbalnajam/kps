        ...
        <div class="id-card">
          ...
          <div class="id-card-body">
            ...
            <div class="teacher-info">
              <h3 class="teacher-name">{{ student.name || 'Student Name' }}</h3>
              <p v-if="student.parents.name" class="student-class">Father: {{ student.parents.name }}</p>
              <p v-if="student.stdclasses.name" class="student-class">Class: {{ student.stdclasses.name }}</p>
            </div>
...
const stdRec = new Resource('students');
...
export default {
  ...
  computed: {
    ...
    qrCodeUrl() {
      return `/student/${this.student.id || ''}/online`;
    },
    currentDate() {
  ...
  methods: {
    ...
    async getStudentData() {
      try {
        const { data } = await stdRec.get(this.stdid);
        ...
        <body>
          <div class="id-card">
            ...
            <div class="id-card-body">
              ...
              <div class="teacher-info">
                <div class="teacher-name">${this.student.name || 'Teacher Name'}</div>
                ${this.student.class_name ? `<div class="teacher-class">Class Teacher: ${this.student.class_name}</div>` : ''}
              </div>
            </div>
