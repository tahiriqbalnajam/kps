<template>
  <div>
    ...
    <el-row :gutter="16" class="summary-row">
      <el-col :span="8">
        <el-card shadow="never" class="summary-card">
          <div class="stat-value">{{ summary.total_cancelled || 0 }}</div>
      ...
      <el-col :span="8">
        <el-card shadow="never" class="summary-card">
          ...
          <div class="stat-label">Cancelled Amount</div>
        </el-card>
      </el-col>
      <el-col :span="8">
        <el-card shadow="never" class="summary-card">
          <div class="stat-value">{{ summary.by_month?.length || 0 }}</div>
          <div class="stat-label">Months Affected</div>
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-table :data="records" border stripe v-loading="loading" class="data-table">
      ...
      <el-table-column prop="notes" label="Notes / Reason" min-width="180" />
    </el-table>
...
const fetchReport = async () => {
  loading.value = true
  try {
    const params = { type: 5, per_page: perPage.value, page: currentPage.value }
