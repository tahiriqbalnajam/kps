<template>
    ...
    >
        <div class="print-toolbar">
            <el-button size="large" type="primary" @click="printVouchers">
                <el-icon>
                    <Printer/>
                </el-icon>
                Print All Vouchers
        ...
        <div id="printVouchers" class="print-container">
            <div
                        ...
                        <div class="voucher-header">
                            <div class="school-info">
                                ...
                                <div class="school-details">
                                    ...
                                    <p v-if="settings.school_tagline" class="school-tagline">{{
                                    ...
                                    <p v-if="settings.school_website" class="school-website">{{
                            ...
                            <div class="voucher-info">
                                ...
                                <div class="voucher-number">Voucher #:
                                    {{ voucher.voucher_number || 'TEMP-' + (index + 1) }}
                                </div>
