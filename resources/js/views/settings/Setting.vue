...
//    import HeadControls from '@/components/HeadControls.vue';
    ...
    const getList = async() => {
        ...
        $this.teacher_form.allowed_holiday = await data.settings.teacher_leaves_allowed;
    }
    getList();
</script>
                  ...
                  <el-tab-pane v-loading="$this.form_element.updating" label="Teacher Settings" name="first">
                    ...
                    <el-form :model="form" >
                      <el-form-item label="Allowed Leaves">
                        <el-input v-model="$this.teacher_form.allowed_holiday" placeholder="Please input allowed leaves " />
                      </el-form-item>
