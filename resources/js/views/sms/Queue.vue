  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button-group style="margin-left: 10px;">
        <el-button :loading="sendsmsloading" type="success" @click="sendSMS()">
          <el-icon>
            <Message/>
          </el-icon>
          Send All
      ...
      <el-button-group style="margin-left: 10px;">
        <el-button :loading="sendsmsloading" type="danger" @click="deleteAll()">
          <el-icon>
            <Delete/>
          </el-icon>
          Delete All
        </el-button>
        <el-button :disabled="multipleSelection.length === 0" type="danger" @click="handleDelete()">
          <el-icon>
            <Delete/>
          </el-icon>
          Delete Selected
    ...
    >
      ...
      <el-table-column align="right">
        <template #header>
          <el-input ref="search" v-model="query.keyword" placeholder="Type to search" size="mini"
    ...
    >
      <div class="demo-drawer__content">
        <el-form :model="sms">
          <el-form-item :label-width="formLabelWidth" label="Message Channel">
            <el-radio v-model="sms.channel" border label="sms">SMS</el-radio>
            <el-radio v-model="sms.channel" border label="whatsapp">WhatsApp</el-radio>
            <el-radio v-model="sms.channel" border label="push-notification">Push Notification</el-radio>
          </el-form-item>
          <el-form-item :label-width="formLabelWidth" label="SMS Type">
            <el-radio v-model="sms.smstype" border label="Single" :disabled="sms.channel === 'push-notification'">Single</el-radio>
            <el-radio v-model="sms.smstype" border label="Multiple" :disabled="sms.channel === 'push-notification'">Multiple</el-radio>
          </el-form-item>
          <el-form-item v-show="sms.smstype === 'Multiple'" :label-width="formLabelWidth" label="Select Classes">
            <el-select v-model="sms.classes" multiple placeholder="Select">
              <el-option v-for="item in classes" :key="item.id" :label="item.name" :value="item.id"/>
            </el-select>
          </el-form-item>
          <el-form-item v-show="sms.smstype === 'Single' && (sms.channel === 'sms' || sms.channel === 'whatsapp')"
                        :label-width="formLabelWidth" label="Phone">
            <el-input v-model="sms.phone" autocomplete="off"/>
          </el-form-item>
          <el-form-item v-show="sms.smstype === 'Single' && (sms.channel === 'push-notification')" :label-width="formLabelWidth"
                        label="Phone">
            <el-input v-model="sms.phone" autocomplete="off"/>
          </el-form-item>
          <el-form-item :label-width="formLabelWidth" label="Message">
            <el-input v-model="sms.message" :rows="2" autocomplete="off" type="textarea"/>
          </el-form-item>
        </el-form>
...
import {Delete, Message, Plus, Select} from '@element-plus/icons-vue';
import {completeSMS, getDefaultMessageChannel, processWhatsApp, updateSendStatusWhatsApp} from '@/api/general';
...
export default {
  ...
  watch: {
    'sms.channel'(newChannel) {
      if (newChannel === 'push-notification') {
        this.sms.smstype = 'Multiple';
      }
    }
  },
